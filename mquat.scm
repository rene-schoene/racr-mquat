...
(define energy (:RealProperty ms pn-energy "J" 'runtime 'decreasing 'sum)) ; for Sample-Component
...
(define (event-worker-off worker-id time)
  ;TODO: actually update status of worker/resource
