...
(library
 (mquat ilp-measurement-paper)
 (export measurement-paper-cli-call)
...
;   (debug comp-name prop-name new-value ast)
 ...
 (define (print-usage) (error "measurement-paper-cli-call" "No valid arguments found, use 'all', 'dirs' or a number of ids."))
 
 (define (measurement-paper-cli-call command-line)
   (cond
