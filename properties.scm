...
(library
 (mquat properties)
 (export timing? profiling? log.debug? log.info? log.warn? write-ilp? measure-flush? measure-non-chached?)
 ...
 (define measure-non-chached? (get-value "measure.non-chached" #f)))
